                ...
                match op:
                    ...
                    case 3: #Reprote Venta por rango de fechas
                        ...
                        if valid==1 and valid2==1:
                            ...
                            print("Formato de fecha incorrrecto")
                        os.system("pause")
                    case 4:
                        ...
                        case 1: #Agregar libro
                            ...
                            if id_formato == 1 and id_existe==-1: #El formato de id es correcto y el id no existe
                                try:
                                    ...
                                    if len(titulo)!=0 and len(autor)!=0 and len(editorial)!=0 and len(año)!=0 and len(idioma)!=0 and len(categoria)!=0 and len(tipo_tapa)!=0 and stock!=0 and precio!=0:    #PASAR A FUNCIÓN
